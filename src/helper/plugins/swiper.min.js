...
!(function (e, t) {
  ...
  function ie(e, t, s) {
    ...
    return (
      r.length ||
        ((r = d(`<div className="swiper-slide-shadow${s ? `-${s}` : ''}"></div>`)), i.append(r)),
      r
    )
  }
  ...
  const re = [
    ...
    function (e) {
      ...
      function T() {
        ...
        0 === r.length &&
          ((r = d(`<div className="${t.params.scrollbar.dragClass}"></div>`)), i.append(r)),
    ...
    function (e) {
      ...
      const i = (e, t, s) => {
        ...
        0 === a.length &&
          ((a = d(`<div className="swiper-slide-shadow-${s ? 'left' : 'top'}"></div>`)),
          e.append(a)),
          0 === i.length &&
            ((i = d(`<div className="swiper-slide-shadow-${s ? 'right' : 'bottom'}"></div>`)),
            e.append(i)),
          ...
          p.shadow &&
            (u
              ? ((m = s.find('.swiper-cube-shadow')),
                0 === m.length &&
                  ((m = d('<div className="swiper-cube-shadow"></div>')), s.append(m)),
                m.css({ height: `${r}px` }))
              : ((m = e.find('.swiper-cube-shadow')),
                0 === m.length &&
                  ((m = d('<div className="swiper-cube-shadow"></div>')), e.append(m))))
          for (let e = 0; e < a.length; e += 1) {
            const t = a.eq(e)
            let s = e
