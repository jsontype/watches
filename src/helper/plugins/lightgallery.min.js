                ...
                t &&
                  (t.classList
                    ...
                    : (t.className = t.className.replace(
                        new RegExp('(^|\\b)' + s.split(' ').join('|') + '(\\b|$)', 'gi'),
                        ' ',
                      )))
              },
                        ...
                        if ('.' === r.substring(0, 1))
                          for (var a in t.Listener)
                            t.Listener.hasOwnProperty(a) &&
                              ...
                              (s.removeEventListener(a.split('.')[0], t.Listener[a]),
                              this.setAttribute(
                                s,
                                'lg-event-uid',
                                this.getAttribute(s, 'lg-event-uid').replace('&' + i[o], ''),
                              ),
                              delete t.Listener[a])
                        else
          ...
          !(function (s, i) {
            ...
            ;(s.prototype.init = function () {
                  ...
                  !(function (t) {
                    l.default.on(e.items[t], 'click.lgcustom', function (s) {
                      s.preventDefault(),
                        ...
                        (e.index = e.s.index || t),
                        l.default.hasClass(document.body, 'lg-on') ||
                          (e.build(e.index), l.default.addClass(document.body, 'lg-on'))
                    })
                  })(s)
            }),
              ...
              (s.prototype.structure = function () {
                ...
                if (
                  ...
                  '.lg-sub-html' === this.s.appendSubHtmlTo &&
                    (i = '<div role="status" aria-live="polite" className="lg-sub-html"></div>'),
                  (o =
                  ...
                  this.s.useLeft
                    ? (l.default.addClass(this.outer, 'lg-use-left'), (this.s.mode = 'lg-slide'))
                  ...
                  this.doCss()
                    ...
                    : (l.default.addClass(this.outer, 'lg-css'), (this.s.speed = 0)),
              ...
              (s.prototype.addHtml = function (e) {
                ...
                '.lg-sub-html' === this.s.appendSubHtmlTo
                  ? (this.outer.querySelector(this.s.appendSubHtmlTo).innerHTML = t)
              ...
              (s.prototype.loadContent = function (e, t, s) {
                ...
                if (i.s.dynamic) {
                  if (
                    (i.s.dynamicEl[e].poster && ((o = !0), (d = i.s.dynamicEl[e].poster)),
                  ...
                  if (
                    ...
                    i.items[e].querySelector('img') &&
                      (g = g || i.items[e].querySelector('img').getAttribute('alt')),
                ...
                i.s.dynamic
                  ...
                  : 'true' === i.items[e].getAttribute('data-iframe') && (h = !0)
                var m = i.isVideo(a, e)
                if (!l.default.hasClass(i.___slide[e], 'lg-loaded')) {
                  ...
                  if (
                    ...
                    n && (r.setAttribute('srcset', n), this.s.supportLegacyBrowser))
                  )
                    try {
                  ...
                  if (!r.lgBusy) {
                    if (this.s.download) {
                      ...
                      ;(c = r.s.dynamic
                        ...
                        : 'false' !== r.items[e].getAttribute('data-download-url') &&
                          (r.items[e].getAttribute('data-download-url') ||
                            r.items[e].getAttribute('href') ||
                            r.items[e].getAttribute('data-src'))),
                        c
                          ? (document.getElementById('lg-download').setAttribute('href', c),
                    ...
                    if (
                      ...
                      e < i
                        ? ((u = !0), 0 !== e || i !== a - 1 || s || ((u = !1), (n = !0)))
                        : e > i && ((n = !0), e !== a - 1 || 0 !== i || s || ((u = !0), (n = !1))),
                        u
                          ? (l.default.addClass(this.___slide[e], 'lg-prev-slide'),
                            l.default.addClass(this.___slide[i], 'lg-next-slide'))
                          : n &&
                    ...
                    r.lGalleryOn
                      ...
                      this.s.counter &&
                        ...
                        (document.getElementById('lg-counter-current').innerHTML = e + 1)
                  }
                }
              }),
              ...
              (s.prototype.arrowDisable = function (e) {
                if (!this.s.loop && this.s.hideControlOnEnd) {
                  ...
                  e + 1 < this.___slide.length
                    ? (t.removeAttribute('disabled'), l.default.removeClass(t, 'disabled'))
                    : (t.setAttribute('disabled', 'disabled'), l.default.addClass(t, 'disabled')),
                    e > 0
                      ? (s.removeAttribute('disabled'), l.default.removeClass(s, 'disabled'))
                      : (s.setAttribute('disabled', 'disabled'), l.default.addClass(s, 'disabled'))
                }
              }),
                ...
                setTimeout(function () {
                  l.default.removeClass(t.outer, 'lg-dragging'),
                    e < 0 && Math.abs(e) > t.s.swipeThreshold
                      ...
                      : e > 0 && Math.abs(e) > t.s.swipeThreshold
                        ? t.goToPrevSlide(!0)
                        : Math.abs(e) < 5 && l.default.trigger(t.el, 'onSlideClick')
                  ...
                  for (var o = 0; o < e.___slide.length; o++)
                    l.default.on(e.___slide[o], 'touchstart.lg', function (s) {
                      l.default.hasClass(e.outer, 'lg-zoomed') ||
                        e.lgBusy ||
                        (s.preventDefault(), e.manageSwipeClass(), (t = s.targetTouches[0].pageX))
                    })
                ...
                if (e.s.enableDrag && !e.isTouch && e.doCss()) {
                  ...
                  l.default.on(window, 'mousemove.lg', function (r) {
                    ...
                    l.default.on(window, 'mouseup.lg', function (r) {
                      o
                        ? ((o = !1), e.touchEnd(s - t), l.default.trigger(e.el, 'onDragend'))
              ...
              (s.prototype.mousewheel = function () {
                ...
                l.default.on(e.outer, 'mousewheel.lg', function (t) {
                  t.deltaY &&
                    (t.deltaY > 0 ? e.goToPrevSlide() : e.goToNextSlide(), t.preventDefault())
                })
              }),
                  ...
                  e.s.closable &&
                    ...
                    l.default.on(e.outer, 'mouseup.lg', function (s) {
                      ;(l.default.hasClass(s.target, 'lg-outer') ||
                        ...
                        (l.default.hasClass(e.outer, 'lg-dragging') || e.destroy())
                    }))
              }),
