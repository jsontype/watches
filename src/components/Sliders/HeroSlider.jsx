...
const sliderData = [
  {
    ...
    title: "トータル修理サービス",
    maintitle: "OH/修理/交換",
    desp: " OHなどを業界最低価格にて実行しております。自社の技師が行います。",
    url: "/appointment",
  ...
  },
  {
    id: 2,
    title: "同伴ショッピング",
    maintitle: "VIPエスコートサービス（10万円 → 無料）",
    desp: " 腕時計をお探しでしょうか？うちのVIPサービスで、あなたのために最適な腕時計を見つけます。GINZA、中野ブロードウェイ、上野で待ち合わせし、お客様に一番お似合いの時計をおすすめ・コーディネートするVIPレベルのエスコートを無料で行います。期間限定で初回無料サービスを行なっております。",
    url: "/appointment",
